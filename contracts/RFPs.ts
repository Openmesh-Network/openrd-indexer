export const RFPsContract = {
  address: "0x03034a94aA7e9A20EC50C1c3494E7f3b4b7B3405",
  abi: [
    ...
    { type: "function", name: "emptyRFP", inputs: [{ name: "_rfpId", type: "uint256", internalType: "uint256" }], outputs: [], stateMutability: "nonpayable" },
    { type: "function", name: "escrowImplementation", inputs: [], outputs: [{ name: "", type: "address", internalType: "address" }], stateMutability: "view" },
    {
      type: "function",
      name: "getRFP",
      ...
      outputs: [
        {
          ...
          components: [
            ...
            { name: "escrow", type: "address", internalType: "contract RFPEscrow" },
            ...
            { name: "budget", type: "address[]", internalType: "contract IERC20[]" },
            {
              name: "projects",
              type: "tuple[]",
              ...
              components: [
                { name: "metadata", type: "string", internalType: "string" },
                { name: "representative", type: "address", internalType: "address" },
                { name: "deadline", type: "uint64", internalType: "uint64" },
    ...
    { type: "function", name: "rfpCount", inputs: [], outputs: [{ name: "", type: "uint256", internalType: "uint256" }], stateMutability: "view" },
    {
      type: "function",
      name: "submitProject",
      inputs: [
    ...
    { type: "function", name: "tasks", inputs: [], outputs: [{ name: "", type: "address", internalType: "contract ITasks" }], stateMutability: "view" },
    {
      type: "event",
      name: "ProjectAccepted",
      inputs: [
        { name: "rfpId", type: "uint256", indexed: true, internalType: "uint256" },
        { name: "projectId", type: "uint32", indexed: false, internalType: "uint32" },
        { name: "nativeReward", type: "uint96[]", indexed: false, internalType: "uint96[]" },
        { name: "reward", type: "uint88[]", indexed: false, internalType: "uint88[]" },
        { name: "taskId", type: "uint256", indexed: false, internalType: "uint256" },
      ],
      anonymous: false,
    },
    {
      ...
      inputs: [
        ...
        { name: "representative", type: "address", indexed: false, internalType: "address" },
    ...
    },
    {
      ...
      inputs: [
        ...
        { name: "metadata", type: "string", indexed: false, internalType: "string" },
        { name: "deadline", type: "uint64", indexed: false, internalType: "uint64" },
        { name: "nativeBudget", type: "uint256", indexed: false, internalType: "uint256" },
        {
          name: "budget",
          type: "tuple[]",
          indexed: false,
        ...
        { name: "tasksManager", type: "address", indexed: false, internalType: "address" },
        ...
        { name: "escrow", type: "address", indexed: false, internalType: "contract RFPEscrow" },
      ],
      anonymous: false,
    },
    { type: "event", name: "RFPEmptied", inputs: [{ name: "rfpId", type: "uint256", indexed: true, internalType: "uint256" }], anonymous: false },
